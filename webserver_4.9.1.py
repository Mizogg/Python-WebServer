...
<p id='fun4' style='color:#34495E ;background:#D7DBDD;padding:3px;font-weight:bold;font-size: 12px;'></p>"
            ...
            if sys.platform == 'linux' or sys.platform == 'darwin':
                self.wfile.write(bytes("<pre class='keys'>\
<strong>WIF Private Key Uncompressed</strong>                         <strong>Uncompressed Address</strong>               <strong>Compressed Address</strong>                  <strong>WIF Private Key Compressed</strong>                            <strong>Private Key Hex</strong><br>", "utf-8"))
