...
#-------------------------------------------------------------------------------------------------AJAX Fetch Page PART---------------------------------------
        ...
        if str_url.startswith("!"): # handle ajax request to get all data for modal popup window
            ...
            beta = 0x7ae96a2b657c07106e64479eac3434e99cf0497512f58995c1396c28719501ee # Cube root of 1
            xcubed = (y*y - 7) % p
...
#---------End for AJAX modal windows---------------------------------------------------------------------------------------------
            ...
            self.wfile.write(bytes("<div class='overlay_popup'></div>", "utf-8"))
            self.wfile.write(bytes("<div class='popup' id='popup1'>", "utf-8"))
            self.wfile.write(bytes("<div class='object'>", "utf-8"))
            self.wfile.write(bytes("<h4 style='color:brown;font-weight:bold;text-align:right;'>Private ECDSA Key&nbsp;&nbsp;\
            ...
            <button class='arrow' id='arrow_right' style='color:blue;'>>>></button>&nbsp;&nbsp;</h4>", "utf-8"))
            self.wfile.write(bytes("<p id='funbin' style='color:#DE3163;background:#D7DBDD;padding:3px;font-weight:bold;font-size: 12px;word-wrap: break-word;'></p>", "utf-8"))
            self.wfile.write(bytes("<p id='funhex' style='color:#DE3163;background:#D7DBDD;padding:3px;font-weight:bold;font-size: 12px;'></p>", "utf-8"))
            self.wfile.write(bytes("<p id='fun' style='color:#DE3163;background:#D7DBDD;padding:3px;font-weight:bold;font-size: 12px;'></p>", "utf-8"))
            self.wfile.write(bytes("<h4 style='color:brown;font-weight:bold;'>Public ECDSA Key</h4>", "utf-8"))
            self.wfile.write(bytes("<p id='fun2x' style='color:#21618C;background:#D7DBDD;padding:3px;font-weight:bold;font-size: 12px;'></p>", "utf-8"))
            self.wfile.write(bytes("<p id='fun2y' style='color:#239B56;background:#D7DBDD;padding:3px;font-weight:bold;font-size: 12px;'></p>", "utf-8"))
            self.wfile.write(bytes("<p id='fun3x' style='color:#21618C;background:#D7DBDD;padding:3px;font-weight:bold;font-size: 12px;'></p>", "utf-8"))
            self.wfile.write(bytes("<p id='fun3y' style='color:#239B56;background:#D7DBDD;padding:3px;font-weight:bold;font-size: 12px;'></p>", "utf-8"))
            self.wfile.write(bytes("<p id='fun5' style='color:#21618C;background:#D7DBDD;padding:3px;font-weight:bold;font-size: 12px;'></p>", "utf-8"))            
            self.wfile.write(bytes("<h4 style='color:brown;font-weight:bold;'>Additive Inverse Point</h4>", "utf-8"))
            self.wfile.write(bytes("<p id='addinvn' style='color:#DE3163;background:#D7DBDD;padding:3px;font-weight:bold;font-size: 12px;''></p>", "utf-8"))
            self.wfile.write(bytes("<p id='addinvx' style='color:#21618C;background:#D7DBDD;padding:3px;font-weight:bold;font-size: 12px;''></p>", "utf-8"))
            self.wfile.write(bytes("<p id='addinvy' style='color:#239B56;background:#D7DBDD;padding:3px;font-weight:bold;font-size: 12px;''></p>", "utf-8"))
            self.wfile.write(bytes("<p id='addrinv' style='color:blue;background:#D7DBDD;padding:3px;font-weight:bold;font-size: 12px;''></p>", "utf-8"))
            self.wfile.write(bytes("<h4 style='color:brown;font-weight:bold;'>Two More Points same Y different X</h4>", "utf-8"))
            self.wfile.write(bytes("<p id='same1x' style='color:#21618C;background:#D7DBDD;padding:3px;font-weight:bold;font-size: 12px;''></p>", "utf-8"))
            self.wfile.write(bytes("<p id='same1y' style='color:#239B56;background:#D7DBDD;padding:3px;font-weight:bold;font-size: 12px;''></p>", "utf-8"))
            self.wfile.write(bytes("<p id='same1addr' style='color:blue;background:#D7DBDD;padding:3px;font-weight:bold;font-size: 12px;''></p>", "utf-8"))
            self.wfile.write(bytes("<p id='same2x' style='color:#21618C;background:#D7DBDD;padding:3px;font-weight:bold;font-size: 12px;''></p>", "utf-8"))
            self.wfile.write(bytes("<p id='same2y' style='color:#239B56;background:#D7DBDD;padding:3px;font-weight:bold;font-size: 12px;''></p>", "utf-8"))
            self.wfile.write(bytes("<p id='same2addr' style='color:blue;background:#D7DBDD;padding:3px;font-weight:bold;font-size: 12px;''></p>", "utf-8"))
            self.wfile.write(bytes("<h4 style='color:brown;font-weight:bold;'>RIPEMD-160 Hash</h4>", "utf-8"))
            self.wfile.write(bytes("<p id='fun4' style='color:#34495E ;background:#D7DBDD;padding:3px;font-weight:bold;font-size: 12px;'></p>", "utf-8"))
            ...
            self.wfile.write(bytes("<h2><span style='color:#34495E;'>Bitcoin addresses database&nbsp;***|&nbsp;" + str(__class__.addr_count) + "&nbsp;|</span></h2>", "utf-8")) 
            ...
            self.wfile.write(bytes("<pre class='keys'><strong>WIF Private Key Uncompressed</strong>                         <strong>Uncompressed Address</strong>               <strong>Compressed Address</strong>                  <strong>WIF Private Key Compressed</strong>                            <strong>Private Key Hex</strong><br>", "utf-8"))
            ###---Loop---******************************************************************
            for i in range(0,128): #generating addresses and WIFS to show on page
                ...
                __class__.starting_key_hex = hex(__class__.startPrivKey)[2:].zfill(64)                    
                self.wfile.write(bytes("<lol style='color:#145A32;'>" + __class__.privKey + "</lol>&nbsp;&nbsp;<lol style='display:inline-block;width:230px;color:#145A32;'><a target='_blank' href='https://bitaps.com/" + __class__.bitAddr + "'>" + __class__.bitAddr + "</a>" + "&nbsp<span>"  + "</span>&nbsp" + "</lol>&nbsp;&nbsp;&nbsp;&nbsp;<lol style='display:inline-block;width:230px;color:#D35400;'><a target='_blank' href='https://bitaps.com/" + __class__.bitAddr_C + "'>" + __class__.bitAddr_C + "</a></lol>&nbsp;&nbsp;&nbsp;<lol style='color:#145A32;'>" + "&nbsp;&nbsp;<lol>" + __class__.privKey_C + "</lol><lol style='color:#DE3163;'>" +"&nbsp;&nbsp;<lol class='show_popup' rel='popup1' num='"+str(i+1)+"' value='"+__class__.starting_key_hex+"'>"+__class__.starting_key_hex+"</lol></br>", "utf-8"))
...
#---------------------------------------------------------Full Page(Without Ajax(when sending requests from url))---------------------
            ...
            self.wfile.write(bytes("<title>BTC Web Server</title>","utf-8"))
    ...
    .arrow:focus {
      outline: none;
            ...
            self.wfile.write(bytes("<div id='auto'> \
            <button class='auto_button' id='start_auto'>Auto Start</button>&nbsp;&nbsp;&nbsp; \
            <button class='auto_button' id='stop_auto'>Auto Stop</button> &nbsp;&nbsp;&nbsp;\
            <span id='status_str' style='color:brown;font-weight: bold;'>Auto: Found [&nbsp;<span id='found_num'>0</span>&nbsp;]&nbsp; \
            Pages checked:&nbsp;<span id='p_checked'>0</span></span>&nbsp;&nbsp;&nbsp;&nbsp;", "utf-8"))
            self.wfile.write(bytes(" \
            ...
            <span id='status_str_seq' style='color:brown;font-weight: bold;'>Sequence: Found [&nbsp;<span id='found_num_seq'>0</span>&nbsp;]&nbsp;&nbsp;&nbsp; \
            Pages checked:&nbsp;<span id='p_checked_seq'>0</span></span></div>", "utf-8"))
            self.wfile.write(bytes("""
            <script>
            ...
            for i in range(0,128): #generating addresses and WIFS to show on page
                ...
                if __class__.bitAddr == __class__.searchKey or __class__.bitAddr_C == __class__.searchKey:
                    self.wfile.write(bytes("<lol style='color:#DE3163;'>" + __class__.privKey + "</lol>&nbsp;&nbsp;<lol style='display:inline-block;width:230px;color:#145A32;'><a target='_blank' href='https://bitaps.com/"+ __class__.bitAddr + "'>" +"<strong>"+ __class__.bitAddr+ "</strong>"+ "</a></lol>&nbsp;&nbsp;&nbsp;&nbsp;<lol style='display:inline-block;width:230px;color:#D35400;'><a target='_blank' href='https://bitaps.com/" + __class__.bitAddr_C+"'>"+"<strong>"+ __class__.bitAddr_C +"</strong>"+ "</a></lol>&nbsp;&nbsp;&nbsp;<lol>" +"&nbsp;&nbsp;<lol style='color:#DE3163;'>"+__class__.privKey_C+"</lol><lol style='color:#DE3163;'>" +"&nbsp;&nbsp;<lol class='show_popup' rel='popup1' style='color:#DE3163;font-weight:bold;' num='"+str(i+1)+"' value='"+__class__.starting_key_hex+"'>"+__class__.starting_key_hex+"</lol></br>", "utf-8"))
                    __class__.searchKey = ""
                elif __class__.bitAddr == __class__.searchKey_U:
                    self.wfile.write(bytes("<lol style='color:#DE3163;'>" + __class__.privKey + "</lol>&nbsp;&nbsp;<lol style='display:inline-block;width:230px;color:#145A32;'><a target='_blank' href='https://bitaps.com/"+ __class__.bitAddr + "'>" +"<strong>"+ __class__.bitAddr+ "</strong>"+ "</a></lol>&nbsp;&nbsp;&nbsp;&nbsp;<lol style='display:inline-block;width:230px;color:#D35400;'><a target='_blank' href='https://bitaps.com/" + __class__.bitAddr_C+"'>"+"<strong>"+ __class__.bitAddr_C +"</strong>"+ "</a></lol>&nbsp;&nbsp;&nbsp;<lol>" +"&nbsp;&nbsp;<lol style='color:#DE3163;'>"+__class__.privKey_C+"</lol><lol style='color:#DE3163;'>" +"&nbsp;&nbsp;<lol class='show_popup' rel='popup1' style='color:#red;font-weight:bold;' num='"+str(i+1)+"' value='"+__class__.starting_key_hex+"'>"+__class__.starting_key_hex+"</lol></br>", "utf-8"))
