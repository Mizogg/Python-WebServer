...
import threading, hashlib, base58, binascii, random, sys
...
<span id='status_page' style='margin-left:482px'>Current page: <span id='pilot_page_seq_num'></span></span></span></div>
<script>
