...
#---------End for AJAX modal windows---------------------------------------------------------------------------------------------
            ...
            self.wfile.write(bytes("<h2><span style='color:#34495E;'>Bitcoin & ETH Address Database Loaded&nbsp;***|&nbsp;" + str(__class__.addr_count) + "&nbsp;|</span></h2>", "utf-8")) 
            ...
            if sys.platform == 'linux' or sys.platform == 'darwin':
                self.wfile.write(bytes("<pre class='keys'><strong>Private Key Hex</strong>                                                          <strong>Uncompressed Address</strong>                <strong>Compressed Address</strong>                       <strong>SegWit 3 Address</strong>                  <strong>bech32 bc1 Address</strong>                           <strong>ETH Address</strong>                           <strong>WIF Private Key Uncompressed</strong>                           <strong>Private Key Hex</strong><br>", "utf-8"))
            ...
            for i in range(0,128): #generating addresses and WIFS to show on page
                ...
                __class__.starting_key_hex = hex(__class__.startPrivKey)[2:].zfill(64)
                self.wfile.write(bytes("<lol style='color:#DE3163;'>" +"<lol class='show_popup' rel='popup1' num='"+str(i+1)+"' value='"+__class__.starting_key_hex+"'>"+__class__.starting_key_hex+"</lol>&nbsp;&nbsp;<lol style='display:inline-block;width:230px;color:#D35400;'><a target='_blank' href='https://bitaps.com/" + __class__.bitAddr_C + "'>" + __class__.bitAddr_C + "</a></lol>&nbsp;&nbsp;&nbsp;<lol style='display:inline-block;width:230px;color:#145A32;'><a target='_blank' href='https://bitaps.com/" + __class__.bitAddr + "'>" + __class__.bitAddr + "</a>" + "&nbsp<span>"  + "</span>&nbsp" + "</lol>&nbsp;&nbsp;&nbsp;&nbsp;<lol style='display:inline-block;width:230px;color:#D35400;'><a target='_blank' href='https://bitaps.com/" + __class__.bitAddr_S + "'>" + __class__.bitAddr_S + "</a></lol>&nbsp;&nbsp;&nbsp;<lol style='display:inline-block;width:230px;color:#145A32;'><a target='_blank' href='https://bitaps.com/" + __class__.bitAddr_bech32 + "'>" + __class__.bitAddr_bech32 + "</a></lol>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<lol style='display:inline-block;width:230px;color:#D35400;'><a target='_blank' href='https://ethplorer.io/address/" + __class__.bitAddr_eth + "'>" + __class__.bitAddr_eth + "</a></lol>&nbsp;&nbsp;<lol style='color:#145A32;'>" + "&nbsp;&nbsp;<lol>" + "&nbsp;&nbsp<span>"  + "</span>&nbsp;&nbsp</lol>&nbsp;&nbsp;" + __class__.privKey + "</lol><lol style='color:#145A32;'>" +"&nbsp;&nbsp;<lol>"+__class__.privKey_C+"</lol></br>", "utf-8"))
            ...
            for addr in __class__.addresses:
                if addr in __class__.arr:
                    ...
                    with open("found.txt", "a", encoding="utf-8") as f:
                        f.write(f"Bitcoin & ETH Address: {addr} Page# {__class__.num} \n") #saving if found: address page#
            ###__Loop End-------------------------------------------------------------------
...
#---------------------------------------------------------Full Page(Without Ajax(when sending requests from url))---------------------
            ...
            self.wfile.write(bytes("<title>BTC&ETH Web Server (Mizogg)</title>","utf-8"))
    ...
    .arrow:focus {
      outline: none;
            ...
            $('#start_auto').click(function() {
                ...
                $('#stop_auto_seq').prop('disabled', true);
             ...
             $('#stop_auto').click(function() {                
                ...
                $('#stop_auto_seq').prop('disabled', false);
