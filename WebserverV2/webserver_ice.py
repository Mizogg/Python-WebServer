...
#---------End for AJAX modal windows---------------------------------------------------------------------------------------------
            ...
            for i in range(0,128): #generating addresses and WIFS to show on page
                ...
                bitAddr_eth = ice.privatekey_to_ETH_address(dec)[2:]
            ...
            for addr in addresses:
                if addr in __class__.bloom_filter:
                    ...
                    with open("found.txt", "a", encoding="utf-8") as f:
                        f.write(f"Bitcoin Address: {addr}  Found on Page# {page_num} \n") #saving if found: address page#
                if addr in __class__.bloom_filter1:
                    status = 'Yes'
                    with open("found.txt", "a", encoding="utf-8") as f:
                        f.write(f"ETH Address: 0x{addr}  Found on Page# {page_num} \n") #saving if found: address page#
            if status == "Yes":
                mixer.init()
...
<p id='fun4' style='color:#34495E ;background:#D7DBDD;padding:3px;font-weight:bold;font-size: 12px;'></p>"
            ...
            for i in range(0,128): #generating addresses and WIFS to show on page
                ...
                __class__.bitAddr_eth = ice.privatekey_to_ETH_address(dec)[2:]
                ...
                if __class__.bitAddr == __class__.searchKey or __class__.bitAddr_C == __class__.searchKey or __class__.bitAddr_S == __class__.searchKey or __class__.bitAddr_bech32 == __class__.searchKey or __class__.bitAddr_eth == __class__.searchKey:
                    self.wfile.write(bytes("<lol style='color:#DE3163;'>" +"<lol class='show_popup' rel='popup1' style='color:#DE3163;font-weight:bold;' num='"+str(i+1)+"' value='"+__class__.starting_key_hex+"'>"+__class__.starting_key_hex+"</lol>&nbsp;&nbsp;<lol style='display:inline-block;width:230px;color:#145A32;'><a target='_blank' href='https://bitaps.com/"+ __class__.bitAddr + "'>" +"<strong>"+ __class__.bitAddr+ "</strong>"+ "</a></lol>&nbsp;&nbsp;&nbsp;<lol style='display:inline-block;width:230px;color:#D35400;'><a target='_blank' href='https://bitaps.com/" + __class__.bitAddr_C+"'>"+"<strong>"+ __class__.bitAddr_C +"</strong>"+ "</a></lol>&nbsp;&nbsp;<lol>" +"&nbsp;&nbsp;<lol style='display:inline-block;width:230px;color:#145A32;'><a target='_blank' href='https://bitaps.com/"+ __class__.bitAddr_S + "'>" +"<strong>"+ __class__.bitAddr_S+ "</strong>"+ "</a></lol>&nbsp;&nbsp;&nbsp;<lol style='display:inline-block;width:230px;color:#D35400;'><a target='_blank' href='https://bitaps.com/" + __class__.bitAddr_bech32+"'>"+"<strong>"+ __class__.bitAddr_bech32 + "</strong>"+ "</a></lol>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<lol style='display:inline-block;width:230px;color:#D35400;'><a target='_blank' href='https://ethplorer.io/address/0x" + __class__.bitAddr_eth+"'>0x"+"<strong>"+ __class__.bitAddr_eth +"</strong>"+ "</a></lol>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<lol style='color:#DE3163;'>" +"&nbsp;&nbsp;<lol>"+"<strong>"+ __class__.privKey+ "</strong>"+"</lol><lol style='color:#DE3163;'>" +"&nbsp;&nbsp;<lol>"+"<strong>"+ __class__.privKey_C+ "</strong>"+"</lol></br>", "utf-8"))
                    __class__.searchKey = ""
                elif __class__.bitAddr == __class__.searchKey_U:
                    self.wfile.write(bytes("<lol style='color:#DE3163;'>" +"<lol class='show_popup' rel='popup1' style='color:#red;font-weight:bold;' num='"+str(i+1)+"' value='"+__class__.starting_key_hex+"'>"+__class__.starting_key_hex+"</lol>&nbsp;&nbsp;<lol style='display:inline-block;width:230px;color:#145A32;'><a target='_blank' href='https://bitaps.com/"+ __class__.bitAddr + "'>" +"<strong>"+ __class__.bitAddr+ "</strong>"+ "</a></lol>&nbsp;&nbsp;&nbsp;<lol style='display:inline-block;width:230px;color:#D35400;'><a target='_blank' href='https://bitaps.com/" + __class__.bitAddr_C+"'>"+"<strong>"+ __class__.bitAddr_C +"</strong>"+ "</a></lol>&nbsp;&nbsp;&nbsp;<lol>" +"&nbsp;<lol style='display:inline-block;width:230px;color:#145A32;'><a target='_blank' href='https://bitaps.com/"+ __class__.bitAddr_S + "'>" +"<strong>"+ __class__.bitAddr_S+ "</strong>"+ "</a></lol>&nbsp;&nbsp;&nbsp;<lol style='display:inline-block;width:230px;color:#D35400;'><a target='_blank' href='https://bitaps.com/" + __class__.bitAddr_bech32+"'>"+"<strong>"+ __class__.bitAddr_bech32 +"</strong>"+ "</a></lol>&nbsp;&nbsp;&nbsp;<lol>" +"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<lol style='display:inline-block;width:230px;color:#145A32;'><a target='_blank' href='https://ethplorer.io/address/0x"+ __class__.bitAddr_eth + "'>0x" +"<strong>"+ __class__.bitAddr_eth+ "</strong>"+ "</a></lol><lol>" + "&nbsp;&nbsp<span>&nbsp;&nbsp;&nbsp;&nbsp;"  + "</span>&nbsp;&nbsp</lol>&nbsp;&nbsp;<lol style='color:#DE3163;'>" +"<strong>"+ __class__.privKey +"</strong>"+ "</lol>&nbsp;&nbsp;<lol style='color:#DE3163;'>"+"<strong>"+__class__.privKey_C+"</strong>"+"</lol></br>", "utf-8"))
                    __class__.searchKey_U = ""
                else:
                    self.wfile.write(bytes("<lol style='color:#DE3163;'>" +"<lol class='show_popup' rel='popup1' num='"+str(i+1)+"' value='"+__class__.starting_key_hex+"'>"+__class__.starting_key_hex+"</lol>&nbsp;&nbsp;<lol style='display:inline-block;width:230px;color:#D35400;'><a target='_blank' href='https://bitaps.com/" + __class__.bitAddr + "'>" + __class__.bitAddr + "</a></lol>&nbsp;&nbsp;&nbsp;<lol style='display:inline-block;width:230px;color:#145A32;'><a target='_blank' href='https://bitaps.com/" + __class__.bitAddr_C + "'>" + __class__.bitAddr_C + "</a>" + "&nbsp<span>"  + "</span>&nbsp" + "</lol>&nbsp;&nbsp;&nbsp;&nbsp;<lol style='display:inline-block;width:230px;color:#D35400;'><a target='_blank' href='https://bitaps.com/" + __class__.bitAddr_S + "'>" + __class__.bitAddr_S + "</a></lol>&nbsp;&nbsp;&nbsp;<lol style='display:inline-block;width:230px;color:#145A32;'><a target='_blank' href='https://bitaps.com/" + __class__.bitAddr_bech32 + "'>" + __class__.bitAddr_bech32 + "</a></lol>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<lol style='display:inline-block;width:230px;color:#D35400;'><a target='_blank' href='https://ethplorer.io/address/0x" + __class__.bitAddr_eth + "'>0x" + __class__.bitAddr_eth + "</a></lol>&nbsp;&nbsp;<lol style='color:#145A32;'>" + "&nbsp;&nbsp;<lol>" + "&nbsp;&nbsp<span>"  + "</span>&nbsp;&nbsp</lol>&nbsp;&nbsp;" + __class__.privKey + "</lol><lol style='color:#145A32;'>" +"&nbsp;&nbsp;<lol>"+__class__.privKey_C+"</lol></br>", "utf-8"))
...
<body link='#0000FF' vlink='#0000FF' alink='#0000FF'>""", "utf-8"))
            self.wfile.write(bytes("<h3><a style='color:green;' href='http://localhost:3334/1'> **********BONUS VERSION********** DETAIL INFORMATION NEW LAYOUT **********BONUS VERSION********** </a></h3>'", "utf-8"))
            ...
            self.wfile.write(bytes("<h2><span style='color:#34495E;'><input type='text' id='search_line' name='lastname' placeholder='Search Field' autocomplete='off'>&nbsp;&nbsp;&nbsp;&nbsp;|</span></h2>", "utf-8"))
